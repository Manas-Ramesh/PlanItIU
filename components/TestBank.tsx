...
export default function TestBank({ userInfo }: TestBankProps) {
    ...
    return (
      <div className="h-full flex flex-col overflow-hidden">
        <div className="bg-white border-b border-gray-200 p-4 flex-shrink-0">
          ...
          <h1 className="text-xl font-bold text-gray-900">{selectedCourse.course_code}</h1>
          <p className="text-gray-600 text-sm mt-1">{selectedCourse.course_name}</p>
        </div>
