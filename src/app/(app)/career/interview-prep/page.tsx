...
function PracticeChatTab() {
  return (
    <div className="mx-auto max-w-2xl flex flex-col items-center py-8">
      <div className="flex size-20 items-center justify-center rounded-full bg-elevated text-text-muted">
        <svg className="size-10" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
          <path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z" />
        </svg>
      </div>
      <h2 className="mt-4 text-xl font-semibold text-text-primary">PlanIt</h2>
      <p className="mt-1 text-text-secondary">Get instant answers and practice questions</p>
      <div className="mt-8 w-full space-y-3">
        <input
          type="text"
          placeholder="Type your message..."
          className="w-full rounded-lg border border-border-subtle bg-surface px-4 py-3 text-text-primary placeholder:text-text-muted"
        />
...
function QuestionDrillsTab() {
  return (
    <div className="mx-auto max-w-4xl space-y-6">
      <section>
        <h2 className="text-lg font-semibold text-text-primary">Drills</h2>
        <p className="text-text-secondary">Practice technical questions and build your skills</p>
      </section>
      <section>
        <p className="text-sm font-medium text-text-primary">Difficulty Level</p>
      ...
      <section>
        <p className="text-sm font-medium text-text-primary">Bank Type</p>
        <div className="mt-2 flex gap-2">
      ...
      <div className="grid grid-cols-2 gap-4 sm:grid-cols-4">
        {[
          ...
          >
            <p className="text-xs font-medium uppercase tracking-wider text-text-muted">{card.title}</p>
      ...
      <div className="flex gap-2">
        <label className="flex items-center gap-2 text-sm text-text-secondary">
          ...
          <input
            type="number"
            className="w-20 rounded border border-border-subtle bg-surface px-2 py-1 text-text-primary"
          />
        </label>
      </div>
      <div className="flex gap-2">
...
function MockInterviewTab() {
  return (
    <div className="mx-auto max-w-3xl space-y-8">
      <section>
        <h2 className="text-xl font-semibold text-text-primary">Mock Interview</h2>
      ...
      <div className="rounded-xl border border-border-subtle bg-surface p-6 text-center">
        ...
        <h3 className="mt-4 font-semibold text-text-primary">Video Interview Simulator</h3>
      ...
      <div className="flex items-center gap-2">
        ...
        <button
          type="button"
          className="flex size-10 items-center justify-center rounded-full border border-border-subtle bg-surface text-text-muted hover:text-text-primary"
          aria-label="Settings"
        >
          <svg className="size-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
