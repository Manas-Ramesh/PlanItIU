...
const SUBTABS = [
  ...
  },
  {
    ...
    icon: (
      <svg className="size-[13px] shrink-0" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
        <rect x="3" y="3" width="4" height="18" rx="1" /><rect x="10" y="3" width="4" height="12" rx="1" /><rect x="17" y="3" width="4" height="8" rx="1" />
      </svg>
    ),
  },
] as const;
    ...
    <div className="flex h-full min-h-0">
      ...
      <aside className="w-[180px] shrink-0 border-r border-[var(--color-border-subtle)]/40 flex flex-col overflow-y-auto">
        <div className="px-3 pt-4 pb-2">
          <p className="text-[10px] font-semibold uppercase tracking-widest text-[var(--color-text-muted)]">Views</p>
        </div>
