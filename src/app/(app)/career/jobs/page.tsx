  ...
  return (
    <div className="mx-auto max-w-4xl space-y-6">
      <div className="rounded-xl border border-border-subtle bg-surface p-4">
        <h3 className="text-sm font-medium text-text-primary mb-3">Job Type</h3>
        ...
        <h3 className="text-sm font-medium text-text-primary mt-4 mb-2">Job Level</h3>
        <div className="flex flex-wrap gap-2">
        ...
        <h3 className="text-sm font-medium text-text-primary mt-4 mb-2">Custom Filters</h3>
        <div className="flex flex-wrap gap-2">
      ...
      <ul className="space-y-4">
        {SAMPLE_JOBS.map((job) => (
          <li
            key={job.id}
            className="rounded-xl border border-border-subtle bg-surface p-4 flex flex-col gap-3"
          >
            <div className="flex items-start justify-between gap-4">
              <div className="flex gap-3">
                ...
                <div>
                  <h3 className="font-semibold text-text-primary">{job.position}</h3>
            ...
            <div className="flex flex-wrap gap-2">
              ...
              {['React', 'Node.js', 'Python'].map((s) => (
                <span key={s} className="rounded bg-elevated px-2 py-0.5 text-xs text-text-secondary">
                  {s}
                </span>
              ))}
            </div>
  ...
  return (
    <div className="mx-auto max-w-5xl space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-xl font-semibold text-text-primary">Application Tracker</h2>
          <p className="text-sm text-text-secondary">Track your job applications and interview progress</p>
        </div>
        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="border-b border-border-subtle bg-elevated text-left">
              <th className="p-3 font-medium text-text-primary">Company</th>
              <th className="p-3 font-medium text-text-primary">Position</th>
              <th className="p-3 font-medium text-text-primary">Location</th>
              <th className="p-3 font-medium text-text-primary">Salary</th>
              <th className="p-3 font-medium text-text-primary">Deadline</th>
              <th className="p-3 font-medium text-text-primary">Contact</th>
          ...
          <tbody>
            {SAMPLE_APPLICATIONS.map((row, i) => (
              <tr key={i} className="border-b border-border-subtle hover:bg-surface">
                ...
                <td className="p-3 text-text-secondary">{row.position}</td>
                <td className="p-3 text-text-secondary">{row.location}</td>
                <td className="p-3 text-text-secondary">{row.salary}</td>
                <td className="p-3 text-text-secondary">{row.deadline}</td>
