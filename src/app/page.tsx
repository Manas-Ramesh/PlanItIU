...
const FEATURES: ReadonlyArray<FeatureItem> = [
  {
    ...
    imagePlaceholder:
      "Screenshot of flashcard deck and practice test interface",
  },
  {
    ...
    imagePlaceholder:
      "Screenshot of weekly calendar view with color-coded courses",
  },
  {
    ...
    imagePlaceholder:
      "Screenshot of degree audit with progress bars and checkmarks",
  },
  {
    id: "ai-advisor",
  ...
  },
  {
    ...
    imagePlaceholder:
      "Screenshot of assignment feedback with grade estimate and suggestions",
  },
  {
    id: "career-center",
    accentGradient: "pink",
    ...
    imagePlaceholder:
      "Screenshot of job listings with filters and alumni network cards",
  },
] as const;
...
const STEPS: ReadonlyArray<StepItem> = [
  {
    ...
    description:
      "Sign up and tell us your university, major, and academic goals so our AI can personalize everything for you.",
    icon: (
      <svg
  ...
  },
  {
    ...
    description:
      "Upload your transcript, add completed courses, and set your preferences. Takes less than 5 minutes.",
    icon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 24 24"
  ...
  },
  {
    ...
    description:
      "Access all tools instantly — build schedules, track your degree, pre-grade assignments, and explore career paths.",
    icon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 24 24"
      ...
      <div className="flex-1 overflow-y-auto">
        <main id="main-content">
          ...
          <HowItWorks
            ...
            subtitle="Three simple steps to take control of your academic journey."
            steps={STEPS}
          />
